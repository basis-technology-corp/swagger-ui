...
```docker run --rm -v $(PWD):/source basistechnologycorporation/build-basis-swagger```

- volume mount this directory to /source in the docker image
- output will be written to ./dist directory
